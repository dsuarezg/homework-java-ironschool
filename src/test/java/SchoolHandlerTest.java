...
class SchoolHandlerTest {
    ...
    void createTeacher_validInput() {
        ...
        SchoolHandler.createTeacher(teachers, scanner);
...
//    }
    ...
    void lookupTeacher_validId() {
        ...
        assertDoesNotThrow(() -> SchoolHandler.lookupTeacher(teachers, teacher.getTeacherId()));
    }

    @Test
    @DisplayName("Test lookupTeacher with invalid ID")
    void lookupTeacher_invalidId() {
        assertThrows(NoSuchElementException.class, () -> SchoolHandler.lookupTeacher(teachers, "invalid_id"));
    }
    ...
    void lookupStudent_validId() {
        ...
        SchoolHandler.lookupStudent(students, studentId);

        assertDoesNotThrow(() -> SchoolHandler.lookupStudent(students, studentId));
    }

    @Test
    @DisplayName("Test lookupStudent with invalid ID")
    void lookupStudent_invalidId() {
        assertThrows(NoSuchElementException.class, () -> SchoolHandler.lookupStudent(students, "invalid_id"));
    }
    ...
    void lookupCourse_validId() {
        ...
        assertDoesNotThrow(() -> SchoolHandler.lookupCourse(courses, course.getCourseId()));
    }

    @Test
    @DisplayName("Test lookupCourse with invalid ID")
    void lookupCourse_invalidId() {
        assertThrows(NoSuchElementException.class, () -> SchoolHandler.lookupCourse(courses, "invalid_id"));
    }

    @Test
    @DisplayName("Test showProfit with no data")
    void showProfit_noData() {
        assertDoesNotThrow(() -> SchoolHandler.showProfit(courses, teachers));
    }
    ...
    void showStudentsByCourse_validCourseId() {
        ...
        SchoolHandler.courses.put(courseId, course);
        assertDoesNotThrow(() -> SchoolHandler.showStudentsByCourse(course.getCourseId()));
    }

    @Test
    @DisplayName("Test showStudentsByCourse with invalid course ID")
    void showStudentsByCourse_invalidCourseId() {
        assertThrows(NoSuchElementException.class, () -> SchoolHandler.showStudentsByCourse("invalid_id"));
    }
    ...
    void showMoneyEarned_withData() {
        ...
        assertDoesNotThrow(() -> SchoolHandler.showMoneyEarned(courses));
    }
    ...
    void showMoneySpent_withData() {
        ...
        assertDoesNotThrow(() -> SchoolHandler.showMoneySpent(teachers));
    }
}